...
![]({{ site.baseurl }}/images/병렬화된-병합정렬과-마이크로벤치마킹/그림3-스레드-개수.png)
...
![]({{ site.baseurl }}/images/병렬화된-병합정렬과-마이크로벤치마킹/그림4-스레드-모습.png)
...
![five]({{ site.baseurl }}/images/병렬화된-병합정렬과-마이크로벤치마킹/그림5-순차-코드-수행-시간.png)

그림 5. 순차 병합정렬의 코드 수행 시간

![five]({{ site.baseurl }}/images/병렬화된-병합정렬과-마이크로벤치마킹/그림6-병렬-코드-수행-시간.png)
