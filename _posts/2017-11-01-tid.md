...
layout:     post
title:      TID 1708-1711
date:       2017-11-01 00:32:18
summary:    일정기간 동안 진행해 본 TID 기록과 간단한 소회
---

좀 더 의식적으로 배우고 성장 하고 싶어서, 남들 하는 TID를 따라 해 봄. 분명 생각 정리하는 데 도움이 됨. 더불어, 오늘 내가 배운 건 뭐가 있는지, 혹시나 기계적 반복을 하는 건 아닌지 의식하게 됨. 하지만 매일 하는 건 참 쉽지 않음.
...
![improvement-machine](/images/tid-171101/improvement-machine.jpg)
...
![novice-to-expert](/images/tid-171101/novice-to-expert.jpeg)
...
-  자세한 내용은 [NavigableMap](https://docs.oracle.com/javase/7/docs/api/java/util/NavigableMap.html) 참고.
